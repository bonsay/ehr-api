...
-- Module catalog -------------------------------------------------------------
INSERT INTO ehr_modules (id, code, name, description, category, api_path, active) VALUES
 (EHR_MODULES_ID_SEQ.NEXTVAL, 'DEMOGRAPHICS', 'Patient Demographics', 'Patient registration and identifying information.', 'Core', 'patients', 1);
INSERT INTO ehr_modules (id, code, name, description, category, api_path, active) VALUES
 (EHR_MODULES_ID_SEQ.NEXTVAL, 'ENCOUNTERS', 'Clinical Encounters', 'Visit notes and clinical documentation.', 'Clinical', 'encounters', 1);
INSERT INTO ehr_modules (id, code, name, description, category, api_path, active) VALUES
 (EHR_MODULES_ID_SEQ.NEXTVAL, 'PROBLEMS', 'Problem List', 'Active and resolved diagnoses.', 'Clinical', 'problems', 1);
INSERT INTO ehr_modules (id, code, name, description, category, api_path, active) VALUES
 (EHR_MODULES_ID_SEQ.NEXTVAL, 'MEDICATIONS', 'Medications', 'Prescriptions and medication history.', 'Clinical', 'medications', 1);
INSERT INTO ehr_modules (id, code, name, description, category, api_path, active) VALUES
 (EHR_MODULES_ID_SEQ.NEXTVAL, 'ALLERGIES', 'Allergies', 'Allergies and intolerances.', 'Clinical', 'allergies', 1);
INSERT INTO ehr_modules (id, code, name, description, category, api_path, active) VALUES
 (EHR_MODULES_ID_SEQ.NEXTVAL, 'VITALS', 'Vital Signs', 'Recorded vital signs.', 'Clinical', 'vitals', 1);
